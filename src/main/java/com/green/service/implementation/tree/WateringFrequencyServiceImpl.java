...
import com.green.service.abstraction.tree.WateringFrequencyService;
...
public class WateringFrequencyServiceImpl implements WateringFrequencyService {
    ...
    public WateringFrequencyDto saveWateringFrequency(WateringFrequencyDto wateringFrequencyDto,
                                                      String lang) {
        Language byLanguageAbbr = languageRepository.findByLanguageAbbr(lang);
        String languageAbbrId = byLanguageAbbr.getId();

        WateringFrequency wateringFrequency =
                modelMapper.map(wateringFrequencyDto, WateringFrequency.class);
    ...
    public List<WateringFrequencyDto> getAllWateringFrequencies(String lang) {
        ...
        List<WateringFrequency> wateringFrequencies =
                wateringFrequencyRepository.findByLanguage_Id(languageAbbrId);
    ...
    public Optional<WateringFrequencyDto> getWateringFrequencyById(String id) {
        Optional<WateringFrequency> wateringFrequencyOptional =
                wateringFrequencyRepository.findById(id);
        return wateringFrequencyOptional.map(
                frequency -> modelMapper.map(frequency, WateringFrequencyDto.class));
    }

    public List<WateringFrequencyDto> getWateringFrequencyByFrequencyName(String frequencyName) {
        List<WateringFrequency> wateringFrequencies =
                wateringFrequencyRepository.findByFrequencyName(frequencyName);
        return wateringFrequencies.stream()
                .map(frequency -> modelMapper.map(frequency, WateringFrequencyDto.class))
                .collect(Collectors.toList());
    }
    ...
    public List<WateringFrequencyDto> getWateringFrequencyByLanguage(String language) {
        List<WateringFrequency> wateringFrequencies =
                wateringFrequencyRepository.findByLanguage_Id(language);
        return wateringFrequencies.stream()
                .map(frequency -> modelMapper.map(frequency, WateringFrequencyDto.class))
                .collect(Collectors.toList());
    }
